...
class AdapterPlaylist(val context: Context, val list: List<Playlist>, var onClickPlaylistListener: OnClickPlaylistListener): RecyclerView.Adapter<AdapterPlaylist.ViewHolder>() {
